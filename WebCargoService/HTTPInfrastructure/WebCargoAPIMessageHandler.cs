...
namespace WebCargoService.HTTPInfrastructure;

public class WebCargoAPIMessageHandler : DelegatingHandler {

    private readonly string _apiKey1;

    private readonly string _apiKey2;

    public WebCargoAPIMessageHandler(IConfiguration configuration) {
        IConfigurationSection configurationSection = configuration.GetSection("WebCargoAPI");
