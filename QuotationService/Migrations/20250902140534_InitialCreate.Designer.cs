...
namespace QuotationService.Migrations
{
    ...
    [Migration("20250902140534_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuotationService.Models.Entities.WebCargoBreakpoint", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("WebCargoRateId")
                        .HasColumnType("bigint");

                    b.HasKey("Id");

                    b.HasIndex("WebCargoRateId");

                    b.ToTable("WebCargoBreakpoints");
                });

            modelBuilder.Entity("QuotationService.Models.Entities.WebCargoRate", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("QuotationService.Models.Entities.WebCargoSurcharge", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("QuotationService.Models.Entities.WebCargoBreakpoint", b =>
                {
                    b.HasOne("QuotationService.Models.Entities.WebCargoRate", null)
                        .WithMany("Breakpoints")
                        .HasForeignKey("WebCargoRateId");
                });
